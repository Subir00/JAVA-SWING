...
public class Cricket_Scorecard extends javax.swing.JFrame {


    public Cricket_Scorecard() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Cricket_Scorecard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cricket_Scorecard().setVisible(true);
            }
        });
    }
