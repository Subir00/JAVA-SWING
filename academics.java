        ...
        log.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {
                try {
                    ...
                    String uname = "root";
                    String pass = "Moni@2002";
                    String query = "SELECT * FROM academics where regd_no = '"+ username.getText()+"'";
